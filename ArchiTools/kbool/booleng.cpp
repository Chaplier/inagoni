...
Bool_Engine::Bool_Engine() : m_MARGE(0), 
							m_GRID(0),
							m_DGRID(0),
							m_CORRECTIONABER(0),
...
bool Bool_Engine::AddPoint( double x, double y, double elevation )//OKTAL MODIFICATION
{
	...
	Node *myNode = new Node( rintx, rinty, elevation, this );//OKTAL MODIFICATION
...
double Bool_Engine::GetPolygonElevationPoint() //OKTAL MODIFICATION
{
	return m_getNode->GetElevation();
}
